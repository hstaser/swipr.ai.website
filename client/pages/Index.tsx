                  ...
                  <div className="bg-gradient-to-br from-pink-500/20 to-purple-600/20 rounded-3xl p-8 backdrop-blur-sm border border-pink-400/30">
                    <div className="space-y-4">
                      <div className="flex items-center p-4 bg-white/10 rounded-xl">
                        ...
                        <Button
                          size="sm"
                          className={followedUsers.has('michael-rodriguez') ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'}
                          onClick={() => handleFollowUser('michael-rodriguez')}
                        >
                          {followedUsers.has('michael-rodriguez') ? 'Following' : 'Follow'}
                        </Button>
                      </div>
                      <div className="flex items-center p-4 bg-white/10 rounded-xl">
                      ...
                      <div className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                            ...
                            <div className="text-right">
                              <div className="text-white font-bold">$185.{Math.floor(Math.random() * 100)}</div>
                              <div className="text-green-400 text-sm">+{(2.4 + (Math.random() - 0.5) * 0.5).toFixed(1)}%</div>
                            </div>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                            <div className="flex items-center space-x-3">
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                            ...
                            <div className="text-right">
                              <div className="text-white font-bold">$248.{Math.floor(Math.random() * 100)}</div>
                              <div className="text-red-400 text-sm">-{(1.8 + (Math.random() - 0.5) * 0.3).toFixed(1)}%</div>
                            </div>
                          </div>
                        </div>
                      </div>
