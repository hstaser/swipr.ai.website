      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-teal-600">
        ...
        <div className="relative container mx-auto px-6 py-24 text-center text-white">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent leading-tight pb-2">
              swipr.ai
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Investing, simplified. Swipe through stocks like social media.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              swipr.ai makes investing accessible for everyone. Swipe through
              curated stocks, build your watchlist, and let our AI optimize your
              portfolio based on your preferences. No jargon, no complexity —
