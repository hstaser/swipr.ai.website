        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-200 max-w-4xl mx-auto leading-relaxed">
              ...
              exclusive to Wall Street elites. Our mission is to make
              intelligent, AI-powered investing accessible, intuitive, and
              profitable for every individual.
            </p>
          </div>
              ...
              <div className="text-lg text-slate-200 leading-relaxed space-y-6">
                <p>
                  <strong className="text-white">
                    The financial industry has failed everyday people.
                  </strong>{" "}
                  For decades, sophisticated investment strategies, portfolio
                  optimization algorithms, and market insights have been hoarded
                  by institutional investors and the ultra-wealthy. Meanwhile,
                  regular people are left with confusing jargon, hidden fees,
                  and outdated investment approaches that barely keep pace with
                  inflation.
                </p>
                ...
                <p>
                  ...
                  swipr.ai represents a fundamental shift in how people interact
                  with financial markets. By combining cutting-edge artificial
                  intelligence with an interface as intuitive as social media,
                  we're breaking down the barriers that have kept intelligent
                  investing out of reach for millions.
                </p>

                <p>
                  Our platform doesn't just make investing easier—it makes it{" "}
                  <em className="text-blue-300">smarter</em>. Every swipe is
                  backed by real-time market analysis, portfolio theory, and
                  machine learning algorithms that continuously optimize for
                  your financial goals. We're not just building an app; we're
                  creating a movement toward financial empowerment.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="mb-20">
            ...
            <p className="text-xl text-slate-200 text-center mb-12 max-w-3xl mx-auto">
              Building the future of finance through five core principles that
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg border border-blue-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    Every decision should be backed by data, algorithms, and
                    artificial intelligence. We replace gut feelings with
                    scientific analysis and emotional trading with logical
                    optimization.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg border border-purple-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    Sophisticated investing shouldn't require a finance degree.
                    We make complex strategies as simple as swiping right,
                    democratizing tools once reserved for Wall Street
                    professionals.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-lg border border-emerald-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    No hidden fees, no misleading marketing, no black-box
                    algorithms. We believe trust is built through transparency,
                    and our users deserve to understand exactly how their money
                    is managed.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg border border-orange-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    Markets move in milliseconds, opportunities vanish in
                    minutes. Our technology operates at the speed of modern
                    finance while maintaining the precision required for optimal
                    outcomes.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg border border-green-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    We optimize for sustainable wealth building, not quick
                    gains. Our algorithms focus on long-term compound growth
                    that builds generational wealth for our users.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-violet-500/20 to-purple-500/20 backdrop-blur-lg border border-violet-400/30 rounded-2xl hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-slate-200">
                    Financial empowerment shouldn't be limited by geography.
                    We're building a platform that can serve investors
                    worldwide, creating global financial inclusion through
                    technology.
                  </p>
                </CardContent>
              </Card>
          ...
          <Card className="bg-gradient-to-br from-red-500/10 to-orange-500/10 backdrop-blur-lg border border-red-400/30 rounded-3xl mb-16">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg text-slate-200">
                Why the traditional financial industry is failing everyday
                investors
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-slate-200">
                        Confusing financial jargon and interfaces
                      </span>
                    </li>
                    <li className="flex items-start">
                      <X className="h-5 w-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start">
                      <X className="h-5 w-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-slate-200">
                        Steep learning curves for basic investing
                      </span>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <X className="h-5 w-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-slate-200">
                        AI tools reserved for institutions
                      </span>
                    </li>
                    <li className="flex items-start">
                      <X className="h-5 w-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-slate-200">
                        Professional advice only for the wealthy
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-6 mt-8">
                ...
                <p className="text-slate-200 leading-relaxed">
                  <strong className="text-red-300">78% of Americans</strong>{" "}
                  live paycheck to paycheck.
                  <strong className="text-red-300">Only 32%</strong> have
                  investments beyond their employer's 401k.
                  <strong className="text-red-300">
                    Average investor returns
                  </strong>{" "}
                  lag the market by 3-4% annually due to poor timing and
                  emotional decisions. Meanwhile, institutional investors with
                  AI-powered strategies consistently outperform by leveraging
                  the same technologies we're now bringing to everyone.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-slate-200 text-sm">
                    Swipe-based investing that feels like social media, making
                    complex decisions simple and intuitive.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-200 text-sm">
                    Continuous portfolio rebalancing and tax-loss harvesting
              ...
              <div className="bg-slate-800/50 rounded-xl p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-slate-200 text-sm ml-8">
                      in portfolio performance vs traditional retail investing
                    </p>
                  </div>
                  <div>
                    <div className="flex items-center mb-3">
                    ...
                    <p className="text-slate-200 text-sm ml-8">
                      in time spent on investment research and management
                    </p>
                  </div>
                  <div>
                    <div className="flex items-center mb-3">
                    ...
                    <p className="text-slate-200 text-sm ml-8">
                      on portfolio optimization and rebalancing services
                    </p>
                  </div>
                  <div>
                    <div className="flex items-center mb-3">
                    ...
                    <p className="text-slate-200 text-sm ml-8">
                      with any investment amount, from $1 to millions
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-lg rounded-3xl p-12 border border-slate-600">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto">
              We're not just building a product—we're building a movement. Every
              person who joins swipr.ai is taking a stand against an outdated
              financial system and choosing a future where intelligent investing
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/#open-roles">
                <Button
                  variant="outline"
                  className="border-cyan-400 text-cyan-300 hover:bg-cyan-400/10 px-8 py-4 rounded-xl text-lg font-semibold"
                >
