        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 leading-relaxed mb-8 max-w-3xl mx-auto">
              Clear, fair terms that protect both you and swipr.ai while
              ensuring the best possible investment experience
            </p>
          ...
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-slate-700 leading-relaxed mb-4">
                  By accessing or using swipr.ai, you agree to be bound by these
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  and swipr.ai. Please read them carefully before using our
                  services.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-slate-700 mb-4">
                  <li>
                    • AI-powered portfolio optimization and investment
                    recommendations
                  </li>
                ...
                <p className="text-slate-700 leading-relaxed">
                  Our services are designed to help you make informed investment
                  decisions. However, all investment decisions are ultimately
                  yours, and you bear full responsibility for your investment
                  outcomes.
                </p>
              </CardContent>
            </Card>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-amber-700 text-sm">
                        ...
                        your account. Please keep your login credentials secure
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 text-sm">
                        All investments carry risk, including the potential loss
                ...
                <ul className="space-y-2 text-slate-700">
                  <li>
                    • swipr.ai provides educational content and tools, not
                    investment advice
                  </li>
                  <li>
                    • We are not a registered investment advisor or
                    broker-dealer
                  </li>
                  <li>• All investment decisions are your responsibility</li>
                  <li>
                    • We do not guarantee investment performance or outcomes
                  </li>
                  <li>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-slate-700 leading-relaxed mb-4">
                  To the maximum extent permitted by law, swipr.ai shall not be
                  liable for any indirect, incidental, special, consequential,
                  or punitive damages, including but not limited to investment
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-slate-700 leading-relaxed mb-4">
                  Your use of swipr.ai is also governed by our Privacy Policy,
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                ...
                <div className="bg-slate-50 rounded-lg p-4 space-y-2">
                  <p>
                    <strong>Email:</strong> legal@swipr.ai
                  </p>
                  <p>
                    <strong>Subject Line:</strong> Terms of Service Question
                  </p>
                  <p>
                    <strong>Response Time:</strong> We will respond within 7
                    business days
                  </p>
                </div>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-slate-700 mb-4">
                  We may update these Terms of Service periodically. When we
                ...
                <p className="text-slate-700 leading-relaxed">
                  Your continued use of swipr.ai after changes become effective
